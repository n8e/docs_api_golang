...
func CreateDocument(c *fiber.Ctx) error {
	...
	if err != nil {
		return c.Status(http.StatusInternalServerError).JSON(responses.APIResponse{Status: http.StatusInternalServerError, Message: "error", Data: &fiber.Map{"data": "Not authorised to create this document"}})
	}
...
func GetDocument(c *fiber.Ctx) error {
	...
	if document.OwnerId != dbUser.Id {
		return c.Status(http.StatusForbidden).JSON(responses.APIResponse{Status: http.StatusForbidden, Message: "error", Data: &fiber.Map{"data": "The logged in user is not authorisd to view this document"}})
	}

	return c.Status(http.StatusOK).JSON(responses.APIResponse{Status: http.StatusOK, Message: "success", Data: &fiber.Map{"data": document}})
}
...
func UpdateDocument(c *fiber.Ctx) error {
	...
	if document.OwnerId != dbUser.Id {
		return c.Status(http.StatusForbidden).JSON(responses.APIResponse{Status: http.StatusForbidden, Message: "error", Data: &fiber.Map{"data": "The logged in user is not authorisd to update this document"}})
	}
	...
	return c.Status(http.StatusOK).JSON(responses.APIResponse{Status: http.StatusOK, Message: "success", Data: &fiber.Map{"data": updatedDocument}})
}
...
func DeleteDocument(c *fiber.Ctx) error {
	...
	if document.OwnerId != dbUser.Id {
		return c.Status(http.StatusForbidden).JSON(responses.APIResponse{Status: http.StatusForbidden, Message: "error", Data: &fiber.Map{"data": "The logged in user is not authorisd to delete this document"}})
	}
	...
	if result.DeletedCount < 1 {
		return c.Status(http.StatusInternalServerError).JSON(responses.APIResponse{Status: http.StatusInternalServerError, Message: "error", Data: &fiber.Map{"data": "Document with specified ID not found!"}})
	}

	return c.Status(http.StatusOK).JSON(responses.APIResponse{Status: http.StatusOK, Message: "success", Data: &fiber.Map{"data": "Document successfully deleted!"}})
}
...
func GetDocuments(c *fiber.Ctx) error {
	...
	return c.Status(http.StatusOK).JSON(responses.APIResponse{Status: http.StatusOK, Message: "success", Data: &fiber.Map{"data": documents}})
}
